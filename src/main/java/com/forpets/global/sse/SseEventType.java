...
public enum SseEventType {
    ...
    REQUEST_REJECTED("케어 신청이 거절되었습니다."),
    REQUEST_ACCEPTED("케어 신청이 수락되었습니다."),
    RESERVATION_CREATED("예약이 생성되었습니다."),
    RESERVATION_CANCEL_REQUESTED("예약 취소 요청이 도착했습니다."),
    RESERVATION_CANCEL_REJECTED("예약 취소 요청이 거절되었습니다."),
    PAYMENT_PARTNER_COMPLETED("상대방이 결제를 완료했습니다."),
