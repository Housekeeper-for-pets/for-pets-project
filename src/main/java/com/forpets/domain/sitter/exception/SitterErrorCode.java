...
public enum SitterErrorCode implements ErrorCode {
    ...
    HAS_ACTIVE_RESERVATION(HttpStatus.CONFLICT, "HAS_ACTIVE_RESERVATION", "CONFIRMED 상태의 예약이 있습니다."),

    SITTER_USED_IN_ACTIVE_PROCESS(HttpStatus.CONFLICT, "SITTER_USED_IN_ACTIVE_PROCESS", "활성상태의 제안, 예약 또는 돌봄 요청이 존재하는 시터프로필은 삭제가 불가능합니다."),
